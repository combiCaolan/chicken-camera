'''
blob (?) detection and contour analysis for counting chickens on a conveyor belt
This approach uses background subtraction and blob detection to count chickens, however, it's not as robust as the YOLO-based methods.
'''
